...
public class TreatmentTypeRCVAdapter extends RecyclerView.Adapter<TreatmentTypeRCVAdapter.ViewHolder> {
    ...
    public TreatmentTypeRCVAdapter(Context mContext, ArrayList<DModelTreatment> mData,
    ...
    @NonNull
    @Override
    public TreatmentTypeRCVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.lay_treatment_item, null);


        return new TreatmentTypeRCVAdapter.ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull final TreatmentTypeRCVAdapter.ViewHolder holder, final int position) {
