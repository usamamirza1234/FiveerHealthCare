...
//                break;
    ...
    private void populatePopulationList() {
        ...
        if (doctorRCVAdapter == null) {
            ...
            lst_treatment.add(new DModelDoctor("Dr. Noor Hasan", "Diabetes", "Delivering her multi-faceted healthcare skills     at ICLDC, Dr. Noor is widely recognised for taking leading roles in medical education and administration, as well her practice in internal medicine, specialising in diabetes.", getContext().getResources().getDrawable(R.drawable.ic_dr4)));
